...
**Live Demo:** [https://Vedant.com](https://Vedant.com)
...
```bash
git clone https://github.com/Vedp6/Portofolio_V5.git
cd Portofolio_V5
npm install
```
...
SELECT
  'developed by Vedant. This project is open-source and free to use.',
  'Vedant',
...
**Eki Zulfar Rachman**  
Website: [eki.my.id](https://Vedant.com) · GitHub: [Vedant](https://github.com/Vedp6)
