        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
              I’m a passionate web developer who enjoys turning ideas into clean, interactive, and user-friendly digital experiences. I work with modern technologies like React, JavaScript, Tailwind CSS, and backend technologies to build full-stack web applications. I love exploring new technologies, solving real-world problems, and continuously improving my development skills. My goal is to create impactful products that combine great design with solid functionality.
                  </p>
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Leveraging AI as a professional tool, not a replacement."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1To7_79L1fAKS_MQPQIeajO1Hxu3Ws5f7/view?usp=sharing" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
