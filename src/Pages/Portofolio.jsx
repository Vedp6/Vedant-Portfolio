...
const techStacks = [
  ...
  { icon: "Visual Studio Code (VS Code).svg", language: "Visual Studio Code" },
  { icon: "vercel.svg", language: "Vercel" },
  { icon: "Cloudinary-Icon--Streamline-Svg-Logos.svg", language: "Cloudinary" },
  { icon: "firebase.svg", language: "Firebase" },
  { icon: "Postman.svg", language: "Postman" },

  { icon: "Redux.svg", language: "Redux Toolkit" },
  { icon: "Clerk--Streamline-Simple-Icons.svg", language: "Clerk" },
...
export default function FullWidthTabs() {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      // Store in localStorage (this functionality is kept as-is)
  ...
  useEffect(() => {
    // Try to read from localStorage first for a faster load
    ...
    fetchData(); // Still call fetchData to sync the latest data
  }, [fetchData]);
