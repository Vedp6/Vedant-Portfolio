...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    // Find the project by the slug generated from its Title
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/Vedp6",
      };
  ...
  const projectUrl = `https://my-portfolio-eight-lyart-90.vercel.app/project/${toSlug(project.Title)}`;

  return (
    <>
      <Helmet>
        <title>{project.Title} — Vedant Patil</title>
        <meta
          name="description"
          content={
            project.Description
              ? project.Description.slice(0, 155)
              : `Project ${project.Title} by Vedant Patil — Full Stack Web Developer.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Vedant Patil`}
        />
        <meta
        ...
        <script type="application/ld+json">{`
          {
            ...
            "author": {
              "@type": "Person",
              "name": "Vedant Patil",
              "url": "https://my-portfolio-eight-lyart-90.vercel.app"
            }
          }
        `}</script>
      </Helmet>
